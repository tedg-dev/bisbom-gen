...
> `docs/deep-dive/sidecar/java/phase1-build-speed-design.md`. This document is retained
...
- `docs/deep-dive/sidecar/sidecar-async-spdx-architecture.md` — architecture doc
