...
| A10 | Build efficiency — inline GitOID capture during the build (eliminate post-build rescan) | Implemented; EC2 golden-validation pending (flag off by default) | US-5 / #11005 / PR tedg-dev/omnibor-analysis#212 — [java/phase1-build-speed-subissues.md](java/phase1-build-speed-subissues.md) |
