...
Open `docs/architecture/development-environment.png`.
...
rsync -avz omnibor-build:/home/ubuntu/omnibor-analysis/docs/build-logs/c-cpp/openosc/<TS>/ docs/build-logs/c-cpp/openosc/<TS>/
```
...
| Build doc | `docs/build-logs/c-cpp/openosc/<TS>/build.md` |
...
**File:** `docs/architecture/omnibor-performance-optimization-proposal.md`
...
Reference: `docs/architecture/sidecar-vs-cleanroom-analysis.md`
