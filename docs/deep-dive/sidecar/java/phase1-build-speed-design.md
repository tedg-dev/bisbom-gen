...
| **Consolidates** | `docs/_archived/performance/phase-isolation-build-time-analysis.md`, the Java-efficiency portions of `docs/deep-dive/phase-isolation/phase-isolation-gap-analysis.md`, and `docs/_archived/performance/bomsh-java-performance-optimization.md` |
...
2. **Phase isolation** — Phase 2 depends on `repo_dir`, which does not exist
   ...
   machines. (Full multi-language audit: `docs/deep-dive/phase-isolation/phase-isolation-gap-analysis.md`.)
...
`docs/deep-dive/phase-isolation/phase-isolation-gap-analysis.md` and tracked separately under the
