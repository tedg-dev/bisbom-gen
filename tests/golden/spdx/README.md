...
- Golden files are generated from **sidecar mode** (Phase 1 + Phase 2
  on Ubuntu) — the authoritative baseline
- All variants (standalone, RHEL, Alpine) are compared against the same
  golden files
